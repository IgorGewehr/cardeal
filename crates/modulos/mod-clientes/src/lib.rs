...
//!
//! Os **comandos** (`CriarPessoa`, `MesclarPessoas`, `DefinirLimiteCredito`…) e **consultas**
//! paginadas, que dependem de `cardeal-storage`; a integração com a `PortaFiscal`
//! (`ConsultarCadastroSefaz`) e a `ExportarDadosDoTitular`. Este módulo **não lança dinheiro**
//! — não há receituário (`docs/modulos/clientes.md` §7).
