...
impl Desenho {
    ...
    fn icone(&self, ui: &Ui, icone: Icone) {
        ...
        match icone {
            ...
            Icone::Caixa => {
                self.fechada(ui, &[(0.12, 0.40), (0.88, 0.40), (0.88, 0.88), (0.12, 0.88)]);
                self.fechada(ui, &[(0.22, 0.16), (0.60, 0.16), (0.60, 0.40), (0.22, 0.40)]);
            ...
            Icone::Pessoas => {
                ...
                self.poli(ui, &[(0.62, 0.60), (0.72, 0.52), (0.86, 0.56), (0.88, 0.80)]);
            }
            Icone::Estoque => {
                self.fechada(ui, &[(0.16, 0.40), (0.58, 0.40), (0.58, 0.86), (0.16, 0.86)]);
                self.poli(ui, &[(0.16, 0.40), (0.38, 0.20), (0.80, 0.20), (0.58, 0.40)]);
                self.poli(ui, &[(0.58, 0.40), (0.80, 0.20), (0.80, 0.66), (0.58, 0.86)]);
            }
            Icone::Nota => {
                self.fechada(
                    ui,
            ...
            Icone::Agenda => {
                self.fechada(ui, &[(0.14, 0.20), (0.86, 0.20), (0.86, 0.88), (0.14, 0.88)]);
